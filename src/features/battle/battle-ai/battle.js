...
var _battlemajors = require('./battle-majors'); var MAJOR_FILE = _battlemajors;
 const majors = MAJOR_FILE.major; exports.majors = majors;

var _battleminors = require('./battle-minors'); var MINOR_FILE = _battleminors;
 const minors = MINOR_FILE.minors; exports.minors = minors;

var _modules = require('./modules'); var Modules = _modules;
var _decision = require('./decision'); var decisionMaker = _decision;

var _battledata = require('./battle-data'); var battleData = _battledata;

const Player = battleData.Player;

var _calc = require('./calc'); var Calc = _calc;
 ...
 class Battle {
    ...
    runMinor(args, kwargs, isIntro) {
        ...
        if (exports.minors[args[0]]) {
            let minor = exports.minors[args[0]];
            let r = 0;
            while (typeof minor === "string" && r <= MAX_RECURSIVE) {
                minor = exports.minors[minor];
                r++;
            }
    ...
    runMajor(args, kwargs, isIntro) {
        if (exports.majors[args[0]]) {
            let major = exports.majors[args[0]];
            let r = 0;
            while (typeof major === "string" && r <= MAX_RECURSIVE) {
                major = exports.majors[major];
                r++;
            }
