export const translations = {
    version: {
        msg: "La version del Bot es $1",
    },
    about: {
        msg: "Soy **$1** un bot multi-plataforma creado por $2 para el servidor Space Showdown, puedes ver mi codigo en $3"
    },
    errorlog: {
        link: "Puedes ver el log de errores aqui $1",
        error: "Lo sentimos, no pudimos encontrar el enlace"
    },
    say: {
        msg: ".say [oracion] - Decir una oracion"
    },
    pick: {
        msg: '.pick [opc1, opc2, ..] - Elige una opcion entre las opciones',
        choose: 'Opcion elegida: **$1**'
    },
	tourhelp: {
        msg: '.tour (formato), (segundos para iniciar u off), (minutos para el autodq u off), (máximo número de users u off), (elimination u roundrobin). Todos los argumentos son opcionales.'
    },
	tourend: {
        err: 'No hay ningún torneo en esta sala', 
        err2: 'El torneo ya ha empezado'
    },
	tournament: {
		'e1': 'requiere rango de moderador (@) o superior para crear torneos',
		e2: 'Ya hay un torneo en esta sala',
		invalid_format: 'El formato $1 no es valido para torneos',
        ...
        paramerror: 'Parámetro $1 no encontrado, Los parámetros correctos son: $2',
	},
	official: {
		not : 'La funcion Leaderboards no esta disponibe para la sala $1',
