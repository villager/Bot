...
export class MoveDecision {
	...
	ultra:any;
	target:any
	constructor(moveId:any, target:any, mega:any, move:any, zmove?:any, ultra?:any) {
		this.type = "move";
...
export class SwitchDecision {
	...
	poke:any;
	pokeId:any;
	constructor(pokeId:any, poke:any) {
		this.type = "switch";
...
function isTooFar(battle:any, a:any, b:any) {
...
function combinateTeamPreview(array:any, i:any, values:any, solutions:any) {
	if (i >= array.length) {
...
function generateTeamCombinations(sideLength:any, requiredLength:any) {
	let comb = [];
	let values = [];
	let array = [];
...
function validateDecision(des:any) {
...
function nextCombinationDecision(array:any, i:any, tables:any, solutions:any) {
	if (i >= array.length) {
...
function cartesianProduct(tables:any) {
	let array = [];
	let comb = [];
