...
import * as MAJOR_FILE from './battle-majors';
export const majors = MAJOR_FILE.major;

import * as MINOR_FILE from './battle-minors';
export const minors = MINOR_FILE.minors;

import * as Modules from './modules';
import * as decisionMaker from './decision';

import * as battleData from './battle-data';
...
export class Battle {
    ...
    leaveInterval:any;
    nextIsRequest:any;
    constructor(server:any, room:any) {
        this.id = room;
        this.title = "";
        this.players = {
            p1: new Player("p1"),
    ...
    sendDecision(decision:any, retry?:any) {
    ...
    message(type:any, player:any, poke:any) {
        if (!this.self) return; // Not playing
    ...
    add(line:any, isIntro:any) {
        this.run(line, isIntro);
        this.log(line);
    }

    run(str:any, isIntro:any) {
        if (!str) return;
    ...
    runMinor(args:any, kwargs:any, isIntro:any) {
        if (args) {
    ...
    getCalcRequestPokemon(sideId:any, forceMega:any) {
