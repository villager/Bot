...
export function getTemplate (poke:any, gen?:number) {
...
export function getMove(move:any, gen?:any) {
    if (!gen || gen > 8 || gen < 1) gen = 8;
    move = toId(move || "");
...
export function getItem (item:any, gen?:number) {
    if (!gen || gen > 8 || gen < 1) gen = 8;
    item = toId(item || "");
    let itemData:any = {};
    let temp;
...
export function getAbility(ab:any, gen?:number) {
    if (!gen || gen > 8 || gen < 1) gen = 8;
    ab = toId(ab || "");
    let ability:any = {};
    let temp;
...
export class Pokemon {
    ...
    prepared:any;
    helpers:any;
    constructor(template:any, properties:any) {
    ...
    addVolatile(volatile:any) {
        volatile = toId(volatile);
        this.volatiles[volatile] = true;
    }

    removeVolatile(volatile:any) {
        volatile = toId(volatile);
    ...
    addBoost(stat:any, n:any) {
        if (!this.boosts[stat]) this.boosts[stat] = 0;
        this.boosts[stat] += n;
    }

    setBoost(stat:any, n:any) {
        this.boosts[stat] = n;
    }
    ...
    markAbility(id:any, isNotBase:any) {
    ...
    prepareMove(move:any, target:any) {
        this.prepared = {
            move: move,
            target: target,
        };
...
export class Player {
    ...
    pokemon:any;
    teamPv:any;
    constructor(id:any, name?:any, avatar?:any) {
        this.id = id || "p0";
        this.name = name || "";
