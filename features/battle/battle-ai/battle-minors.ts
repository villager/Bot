...
let battleData = require("./battle-data.js");

export const minors = {
	"-damage": function (args:any, kwargs?:any) {
	...
	"-heal": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-sethp": function (args:any, kwargs?:any) {
		let poke, hp;
	...
	"-boost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let stat = args[2];
	...
	"-unboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let stat = args[2];
		let n = parseInt(args[3]) || 0;
	...
	"-setboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let stat = args[2];
		let n = parseInt(args[3]) || 0;
	...
	"-swapboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-restoreboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-copyboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let poke2 = this.getActive(args[2]);
		if (args[3]) {
			let stats = args[3].split(",");
	...
	"-clearboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		poke.removeAllBoosts();
	},

	"-invertboost": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		poke.invertAllBoosts();
	},

	"-clearallboost": function (args:any, kwargs?:any) {
	...
	"-supereffective": "-crit",
	"-resisted": "-crit",
	"-crit": function (args:any, kwargs:any, isIntro:any) {
	...
	"-immune": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-fail": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let effect = battleData.getEffect(args[2], this.gen);
		let fromeffect = battleData.getEffect(kwargs.from, this.gen);
		let ofpoke = this.getActive(kwargs.of);
	...
	"-prepare": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let move = args[2];
	...
	"-status": function (args:any, kwargs:any, isIntro) {
		let poke = this.getActive(args[1]);
		poke.status = args[2];
	...
	"-curestatus": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		poke.status = '';
		if (!args[2] || args[2] === "confusion") poke.removeVolatile('confusion');
	},

	"-cureteam": function (args:any, kwargs?:any) {
		let ident = this.parsePokemonIdent(args[1]);
	...
	"-item": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-enditem": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let item = battleData.getItem(args[2], this.gen);
		let effect = battleData.getEffect(kwargs.from, this.gen);
		let ofpoke = this.getActive(kwargs.of);
	...
	"-ability": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-endability": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		poke.supressedAbility = true;
	},

	"-transform": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-formechange": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-mega": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
	...
	"-end": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let effect = battleData.getEffect(args[2], this.gen);
		let fromeffect = battleData.getEffect(kwargs.from, this.gen);
	...
	"-activate": function (args:any, kwargs?:any) {
		let poke = this.getActive(args[1]);
		let ident = this.parsePokemonIdent(args[1]);
		let effect = battleData.getEffect(args[2], this.gen);
		let ofpoke = this.getActive(kwargs.of);
	...
	"-sidestart": function (args:any, kwargs?:any) {
		let side = this.getSide(args[1]);
		let effect = battleData.getEffect(args[2], this.gen);
		side.addSideCondition(effect.name);
	},

	"-sideend": function (args:any, kwargs?:any) {
		let side = this.getSide(args[1]);
		let effect = battleData.getEffect(args[2], this.gen);
		side.removeSideCondition(effect.name);
	},

	"-weather": function (args:any, kwargs?:any) {
	...
	"-fieldstart": function (args:any, kwargs?:any) {
		let effect = battleData.getEffect(args[1], this.gen);
		let pw = toId(effect.name);
		this.conditions[pw] = {turn: this.turn};
	},

	"-fieldend": function (args:any, kwargs?:any) {
		let effect = battleData.getEffect(args[1], this.gen);
		let pw = toId(effect.name);
		if (this.conditions[pw]) delete this.conditions[pw];
	},

	"-message": function (args:any, kwargs?:any) {
